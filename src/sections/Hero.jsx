...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate h-screen bg-black flex flex-col justify-end overflow-x-hidden overflow-y-visible z-10"
    >
      ...
      <div className="w-full px-6 pb-20 flex flex-col gap-20 z-10">
        ...
        <div className="w-full mx-auto flex items-center justify-between text-[12px] font-spaceg tracking-wide">
...
function MarqueeChunk() {
  return (
    <span
      className="
        pr-[4rem]
        text-[240px] leading-none font-urbanist font-normal
        select-none
      "
