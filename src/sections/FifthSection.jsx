...
export default function FifthSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate h-[200vh] bg-dark px-6 text-light overflow-y-hidden"
    >
      <div
        ref={headingRef}
        className="fixed top-0 w-full z-10 flex h-screen items-center justify-center px-6"
      >
        <h4 className="title-32 max-w-[30vw] text-center font-normal leading-tight">
          Full-time perfection seeker.
          <br />
          Love minimalism, Japanese culture and space.
        </h4>
      </div>
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col align-center">
        ...
        <div
          ref={stickersRef}
          className="relative h-[500vh] z-10 w-full"
        >
